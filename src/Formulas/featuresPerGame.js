...
export const ppgMatchup = (games, oppTeam, currentIndex, fallBack) => {
  const allPreviousGames = games.slice(0, currentIndex);
  const previousMatchups = allPreviousGames.filter((game) => {
