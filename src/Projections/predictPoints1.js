...
const modelPath = "src/models/model1.onnx"; // Path to your ONNX model

export const runModel1 = async (inputData) => {
  const indicesToRemove = [1, 2, 3, 5, 10, 42, 43, 73, 74];
  ...
  try {
    ...
    //   if (err) {
    //     console.error(
    //       "Model file does not exist at the specified path:",
    //       modelPath
    //     );
    //   } else {
    //     console.log("Model file found at path:", modelPath);
    //   }
    // });
...
// // Run predictions
// const test = async () => {
//   const data = await runModel1(inputData);
//   console.log(data);
// };
// test();
