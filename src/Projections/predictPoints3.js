...
const modelPath = "src/models/model3.onnx"; // Path to your ONNX model

export const runModel3 = async (inputData) => {
  const indicesToRemove = [1, 2, 3, 5, 7, 10, 11, 12, 39, 42, 43, 48, 73, 74];
